...
submitParameterList=(
pcapFilename=$samplesDirectory/SampleNetworkToolkitData/data/sample_netflow9_old.pcap
#pcapFilename=$samplesDirectory/SampleNetworkToolkitData/data/sample_netflow9_new.pcap
)
