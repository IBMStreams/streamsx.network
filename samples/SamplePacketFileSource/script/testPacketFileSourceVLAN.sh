...
submitParameterList=(
pcapFilename=$samplesDirectory/SampleNetworkToolkitData/data/sample_vlan_1000_packets.pcap
)
...
rm -rf $dataDirectory/debug.$composite.*.out
